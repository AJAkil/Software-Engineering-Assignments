...
public class PatternTester {
    ...
    public static String[] getInputFromFile(String fileName) throws NullPointerException {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            if(!(userchoice.equalsIgnoreCase("ComputerA")||userchoice.equalsIgnoreCase("ComputerB")||userchoice.equalsIgnoreCase("ComputerC"))){
                ...
                cmpfactory = FactoryProducer.getFactory(userchoice);
